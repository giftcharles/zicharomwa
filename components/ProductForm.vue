<template>
    <v-card
        ...
        class="pa-3 d-flex flex-column mx-auto"
        tile
        flat
    >
        ...
        <v-form class="d-flex flex-column mx-auto">
                    ...
                    <v-expand-transition>
                        ...
                        >
                            <v-icon color="black" small class="mr-1"
                                >mdi-link</v-icon
                            >
                            <span class="text--darken-2">{{ slug }}</span>
                        </div>
                    </v-expand-transition>
                </div>
            </v-card>
            ...
            <v-card class="d-flex flex-column pa-5 mb-8" outlined tile>
                <div class="d-flex align-center mb-8">
                    <span class="mr-6 subtitle-2" style="min-width: 50%"
                        >Price:</span
                    >
                    <v-card
                        outlined
            ...
            <v-card
                outlined
                tile
                class="pa-5 d-flex flex-column justify-center mb-8"
            >
                <div class="mb-3">
            ...
            <v-card outlined tile class="pa-5 d-flex flex-column mb-8">
                <span class="mr-6 subtitle-2 mb-3" style="min-width: 50%"
                    >Category</span
                >
                <v-select
            ...
            <v-card outlined tile class="pa-5 d-flex flex-column mb-8">
                <span class="mr-6 subtitle-2 mb-3" style="min-width: 50%"
                    >Description</span
                >
                <v-textarea hide-details v-model="description" outlined>
                </v-textarea>
            </v-card>
            ...
            <div class="d-flex justify-end mb-8">
                <v-btn v-if="!id" x-large text color="primary" class="mr-3">
                ...
                >
                    <span class="mr-3">{{ this.id ? 'Save' : 'Publish' }}</span>
...
export default {
        ...
        if (this.id) {
            ...
            this.$fire.firestore
                ...
                .onSnapshot((snap) => {
                    ...
                    this.quantityToSell = this.product.stockAmount || 0;
                    this.category = this.product.category
                        ? this.product.category.id.toString()
                        : "0";
    ...
    methods: {
        ...
        submit(status) {
            ...
            let data = {
                ...
                price: this.price,
                category:
                    this.$store.state.categories[parseInt(this.category) - 1],
            };
                ...
                .then(() => {
                    ...
                    return this.$fire.firestore
                        ...
                        .set(
                            {
                                productsCount:
                                    this.$fireModule.firestore.FieldValue.increment(
                                        1
                                    ),
                            },
                            { merge: true }
    ...
    computed: {
        ...
        slug() {
            return (
                this.name.toLowerCase().slice(0, 90).split(" ").join("-") +
                `.${(this.$store.state.business.productsCount + 1)
                    .toString()
                    .padStart(4, "0")}`
            );
        },
